...
# Import target "MaaFramework::MaaAgentClient" for configuration "Release"
set_property(TARGET MaaFramework::MaaAgentClient APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(MaaFramework::MaaAgentClient PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/MaaAgentClient.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "opencv_core;opencv_imgproc;opencv_imgcodecs;MaaFramework::MaaUtils;MaaFramework::MaaFramework"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/MaaAgentClient.dll"
  )
